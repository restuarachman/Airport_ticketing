 ...
 * @author restu
 */
public class View_Panel_Admin_NEW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Menu_Atur_Data_Penerbangan = new javax.swing.JPanel();
        ...
        Menu_Atur_Data_Penerbangan.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(204, 204, 204), new java.awt.Color(204, 204, 204), new java.awt.Color(204, 204, 204), new java.awt.Color(204, 204, 204)));
        Menu_Atur_Data_Penerbangan.setOpaque(false);
        Menu_Atur_Data_Penerbangan.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/icon/admin_atur_jadwalPenerbangan.gif"))); // NOI18N
        Menu_Atur_Data_Penerbangan.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 130, 90));

        jLabel8.setBackground(new java.awt.Color(48, 57, 82));
        jLabel8.setForeground(new java.awt.Color(48, 57, 82));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("Penerbangan");
        Menu_Atur_Data_Penerbangan.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 126, 150, 20));

        jLabel9.setBackground(new java.awt.Color(48, 57, 82));
        jLabel9.setForeground(new java.awt.Color(48, 57, 82));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("Atur Jadwal");
        Menu_Atur_Data_Penerbangan.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, 150, -1));

        bodyPanel.add(Menu_Atur_Data_Penerbangan, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 170, 150, 150));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/icon/admin_atur_dataPesawat.gif"))); // NOI18N
        Menu_Atur_Data_Pesawat.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 130, 90));

        jLabel6.setBackground(new java.awt.Color(48, 57, 82));
        jLabel6.setForeground(new java.awt.Color(48, 57, 82));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Atur Data Pesawat");
        Menu_Atur_Data_Pesawat.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, 150, -1));

        bodyPanel.add(Menu_Atur_Data_Pesawat, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 170, 150, 150));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/icon/admin_atur_dataBandara.gif"))); // NOI18N
        Menu_Atur_Data_Bandara.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 150, 70));

        jLabel2.setBackground(new java.awt.Color(48, 57, 82));
        jLabel2.setForeground(new java.awt.Color(48, 57, 82));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Atur Data Bandara");
        Menu_Atur_Data_Bandara.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, 150, -1));

        bodyPanel.add(Menu_Atur_Data_Bandara, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, 150, 150));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Panel_Admin_NEW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JPanel Menu_Atur_Data_Penerbangan;
